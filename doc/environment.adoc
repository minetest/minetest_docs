...
See the reference manual for platform- and OS-environment-dependant Lua features: https://www.lua.org/manual/5.1/manual.html. These include:
...
Warning. Platform-independence is not guaranteed: "The definitions of letter, space, and other character groups depend on the current locale." - https://www.lua.org/manual/5.1/manual.html#5.4.1
